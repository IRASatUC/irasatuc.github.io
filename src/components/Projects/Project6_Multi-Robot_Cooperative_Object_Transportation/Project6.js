    ...
    return (
        <div>
            <div style={{padding: "20px"}}>
                <h1 className="Project6_header pt-0">Multi-Robot Cooperative Object Transportation</h1>

                <h2 className="Project6_header">Research Goal</h2>
                ...
                <h2 className="Project6_header">Strategic Alignment</h2>
                ...
                <h2 className="Project6_header">Objectives</h2>
                ...
                <h2 className="Project6_header">Approach</h2>
                ...
                <h2 className="Project6_header">Applications</h2>
                <ul style={{listStyleType:"disc"}}>
                ...
                <h2 className="Project6_header">State-of-the-art</h2>
