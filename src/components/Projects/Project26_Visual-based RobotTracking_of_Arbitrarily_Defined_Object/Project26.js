import Project26_video1 from './Project26_video1.mp4';
import Project26_video2 from './Project26_video2.mp4';
...
export default function Project26() {
  return (
    <ProjectUI
      projectDescription={Project26_Description}
      projectVideo={[{
        title: "Poke an Object",
        src: Project26_video1
      }, {
        title: "Track an Object",
        src: Project26_video2
      }]}
