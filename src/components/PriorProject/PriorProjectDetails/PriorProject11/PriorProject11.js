...
function PriorProject11_Description() {
    return (
                ...
                title:()=>{
                    return(
                        <div style={{color:"white"}}>
                            ...
                            <h1 style={headerStyle}>Demonstration</h1>
