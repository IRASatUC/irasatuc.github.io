...
function PriorProject13_Description() {
    return (
...
function PriorProject13_Publications(){
    return(
        <div>
        <ul>
          <li>
...
export default function PriorProject13() {
    return (
        <ProjectUI
            projectTitle="Contact Dynamics Modeling and Simulation"
            projectTeaser=""
            projectDescription={PriorProject13_Description}
            projectImage={[{
                title: "",
                src: Picture1,
            },{
            ...
            Publications={PriorProject13_Publications}
