...
export default function PriorProject4() {
    return (
        <div className='PriorProject4'>
            ...
            <div className='PriorProject4_img'>
            ...
            <div className='PriorProject4_publication'>
