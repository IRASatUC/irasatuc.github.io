...
export default function NewsCard(props) {
    return(<div className="bg-white overflow-hidden border-b-4 border-blue-500 w-1/3">
        <img src="https://images.unsplash.com/photo-1573748240263-a4e9c57a7fcd" alt="People" className="w-full object-cover h-32 sm:h-48 md:h-64">
            ...
            <div className="p-4 md:p-6">
                <p className="text-blue-500 font-semibold text-xs mb-1 leading-none"><a href="https://www.sciencenews.org/">News</a></p>
